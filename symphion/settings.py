...
WSGI_APPLICATION = 'symphion.wsgi.application'
ASGI_APPLICATION = 'symphion.asgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='symphion_db'),
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'symphion.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
